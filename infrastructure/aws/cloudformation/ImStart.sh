...
echo "Creating stack..."
aws cloudformation create-stack --stack-name $STACK_NAME --template-body file://IM.json --capabilities CAPABILITY_NAMED_IAM --parameters ParameterKey=username,ParameterValue=$USER_NAME
# \
